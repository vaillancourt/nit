...
redef class Program
	...
	fun dump_reachable_methods_from_init(directory_name: String) do
		var f = new OFStream.open("{directory_name}/{main_module.cmangled_name}.reachable_methods_from_init.log")
	...
	fun dump_unreachable_methods_from_init(directory_name: String) do
		var f = new OFStream.open("{directory_name}/{main_module.cmangled_name}.unreachable_methods_from_init.log")
		with_each_methods !action(m) do
