...
redef class Program
	...
	fun dump_reachable_methods(directory_name: String, algo: String) do
		var f = new OFStream.open("{directory_name}/{main_module.cmangled_name}.reachable_methods.{algo}.log")
	...
	fun dump_unreachable_methods(directory_name: String, algo: String) do
		var f = new OFStream.open("{directory_name}/{main_module.cmangled_name}.unreachable_methods.{algo}.log")
		with_each_methods !action(m) do
